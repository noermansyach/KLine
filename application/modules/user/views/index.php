					  	...
					  	<div class="card-body">
						    ...
						    <div class="d-lg-flex justify-content-between align-items-center pt-2 pb-3 border-bottom">
						        ...
						        <div class="ml-lg-auto d-flex align-items-stretch justify-content-end">
						            <a href="<?php echo base_url('user/add/') ?>" class="btn btn-success no-wrap ml-0" title="add">+ add user</a>
						        </div>
						    </div>
										...
										<table id="order-listing" class="table">
											...
											<tbody>
												...
												?>
														<tr>
															<td><?php echo $no++; ?></td>
															<td><?php echo strtoupper($value->username); ?></td>
															<td><?php echo strtoupper($value->level); ?></td>
															<td><?php echo ($value->is_active) ? 'Yes': 'No'; ?></td>
															<td class="text-center">
																<a href="<?php echo base_url('user/edit/'.$value->id_user); ?>" class="btn btn-warning" title="edit"><i class="mdi mdi-pencil"></i> </a>
															</td>
														</tr>
												<?php 
														}
